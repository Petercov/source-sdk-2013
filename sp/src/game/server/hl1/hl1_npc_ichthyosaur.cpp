...
ConVar sk_ichthyosaur_hl1_health ( "sk_ichthyosaur_hl1_health", "0" );
ConVar sk_ichthyosaur_hl1_shake ( "sk_ichthyosaur_hl1_shake", "0" );
	...
	case ICHTHYOSAUR_AE_SHAKE_LEFT:
		{
			...
			if (hEnemy != NULL && FVisible( hEnemy ))
			{
				...
				if (DotProduct( vecShootDir, vForward ) > 0.707)
				{
					...
					CTakeDamageInfo info( this, this, sk_ichthyosaur_hl1_shake.GetInt(), DMG_SLASH );
