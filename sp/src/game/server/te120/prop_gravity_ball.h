...
public:
	...
	CHandle< CWeaponPhysConcussion > m_hWeaponPC;

	virtual void Precache();
	virtual void Spawn();
	virtual bool OnAttemptPhysGunPickup(CBasePlayer* pPhysGunUser, PhysGunPickup_t reason = PICKED_UP_BY_CANNON) { return false; }
