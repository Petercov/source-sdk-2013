...
BEGIN_DATADESC( CShieldBeamNode )
	...
	DEFINE_FIELD( m_pNextNode,			FIELD_CLASSPTR	),
...
BEGIN_DATADESC( CShieldBeam )
	...
	DEFINE_FIELD( m_hHead,				FIELD_EHANDLE ),
	DEFINE_FIELD( m_nHeadAttachment,	FIELD_INTEGER ),
	DEFINE_FIELD( m_hTail,				FIELD_EHANDLE ),
	DEFINE_FIELD( m_vTailOffset,		FIELD_VECTOR ),

	DEFINE_FIELD( m_fSpeed,			FIELD_FLOAT ),
	DEFINE_FIELD( m_pBeamNode,			FIELD_CLASSPTR ),
	DEFINE_FIELD( m_fNextNodeTime,		FIELD_FLOAT ),
	DEFINE_FIELD( m_bKillBeam,			FIELD_BOOLEAN ),
	DEFINE_FIELD( m_bReachedTail,		FIELD_BOOLEAN ),
	DEFINE_FIELD( m_fBrightness,		FIELD_FLOAT ),
	DEFINE_FIELD( m_fNoise,			FIELD_FLOAT ),
	DEFINE_FIELD( m_vInitialVelocity,	FIELD_VECTOR ),
	DEFINE_FIELD( m_pBeam,				FIELD_CLASSPTR ),

	// Function Pointers
	DEFINE_THINKFUNC( ShieldBeamThink ),
