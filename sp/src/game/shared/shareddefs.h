...
enum
{
	...
	MUZZLEFLASH_RPG,
	MUZZLEFLASH_SNIPER,
	MUZZLEFLASH_COMBINE_PISTOL,
	MUZZLEFLASH_COMBINE_SMG,
...
enum
{
	...
	ENTITY_DISSOLVE_GLUON,

	ENTITY_DISSOLVE_COUNT,

	ENTITY_DISSOLVE_FIRST_SPECIAL = ENTITY_DISSOLVE_GLUON,
	ENTITY_DISSOLVE_SPECIAL_COUNT = ENTITY_DISSOLVE_COUNT - ENTITY_DISSOLVE_FIRST_SPECIAL,
...
#ifdef MAPBASE
	BLOOD_COLOR_HL1_HUMAN,
	BLOOD_COLOR_HL1_ALIEN,
#endif
};
