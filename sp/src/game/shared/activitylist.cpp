...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY(ACT_RANGE_ATTACK_AUTOSHOTGUN);
	REGISTER_SHARED_ACTIVITY(ACT_RANGE_ATTACK_AUTOSHOTGUN_LOW);
	REGISTER_SHARED_ACTIVITY(ACT_GESTURE_RANGE_ATTACK_AUTOSHOTGUN);
