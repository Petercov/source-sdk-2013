...
void EventList_RegisterSharedEvents( void )
{
	...
	REGISTER_SHARED_ANIMEVENT( AE_WPN_PLAYWPNSOUND, AE_TYPE_WEAPON | AE_TYPE_SERVER );
	...
	REGISTER_SHARED_ANIMEVENT(AE_NPC_MAKE_INTERACTION_DEATHSOUND, AE_TYPE_SERVER);

	REGISTER_SHARED_ANIMEVENT(AE_PISTOL_FIRE_LEFT, AE_TYPE_SERVER | AE_TYPE_WEAPON);
	REGISTER_SHARED_ANIMEVENT(AE_PISTOL_FIRE_RIGHT, AE_TYPE_SERVER | AE_TYPE_WEAPON);
#endif
...
#ifdef EZ2_WEAPONS
	REGISTER_SHARED_ANIMEVENT(AE_SLIDERETURN, AE_TYPE_CLIENT | AE_TYPE_SERVER | AE_TYPE_WEAPON);
#endif
}